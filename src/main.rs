...
fn main() -> Result<()> {
    ...
    if !matches!(
        cli.command,
        Commands::Init(_) | Commands::Doctor(_) | Commands::Options(_) | Commands::Examples(_)
    ) {
    ...
    let result = match cli.command {
        ...
        Commands::Branch(args) => commands::branch::execute(args),
        Commands::Remote(args) => commands::remote::execute(args),
        Commands::Release(args) => commands::release::execute(args),
        Commands::UpdateRepo(args) => commands::update_repo::execute(args),
        Commands::SetupRepo(args) => commands::setup_repo::execute(args),
        Commands::MakePublic(args) => commands::remote::make_public(args),
        Commands::MakePrivate(args) => commands::remote::make_private(args),
        Commands::DeleteRepo(args) => commands::remote::delete_repo_alias(args),
        Commands::Examples(args) => commands::examples::execute(args),
