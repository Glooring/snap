...
- `snap doctor` confirms Git and Snap metadata still look healthy.
...
Avoid release-looking labels such as `v1.2.3` for routine checkpoints until Snap's tag model is improved.
